        ...
        <>  
            <div className="create-new-post-container">
                <h1>Create a new Post here!</h1>
                    ...
                    <input id="title" placeholder="Name the title of your problem" type="text" onChange={(evn) => setTitle(evn.target.value)}/>
                    <textarea name="" onChange={(evn) => setDesc(evn.target.value)} placeholder="Type in what the problem is..." id=""></textarea>
